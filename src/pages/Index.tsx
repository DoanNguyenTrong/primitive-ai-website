...
const Index = () => {
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-primitive-900 via-primitive-800 to-primitive-950 text-white py-20 md:py-32">
        <div className="section-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <h1 className="hero-heading animate-fade-in">
                Transform Your Business with <span className="bg-gradient-to-r from-primitive-300 to-primitive-100 bg-clip-text text-transparent">Advanced AI</span> Solutions
              </h1>
              ...
              <div className="flex flex-wrap gap-4 animate-fade-in" style={{animationDelay: '200ms'}}>
                <Button className="bg-white text-primitive-800 hover:bg-gray-100 text-lg px-8 py-6">
            ...
            <div className="relative animate-float">
              ...
              <div className="relative bg-primitive-950 rounded-lg p-6">
                <img 
